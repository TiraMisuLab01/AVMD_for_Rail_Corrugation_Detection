...
# --- 数据加载部分保持不变 ---
# 左轨
data_path1 = r'E:\桌面文件存放\高速列车轨道波摩检测模型设计\Code\normal_result_left_fixed_k_output.xlsx'
data1 = pd.read_excel(data_path1)
rms1 = data1['RMS_Left']

data_path2 = r'E:\桌面文件存放\高速列车轨道波摩检测模型设计\Code\bomo_result_left_fixed_k_output.xlsx'
data2 = pd.read_excel(data_path2)
rms2 = data2['RMS_Left']

# 右轨
# data_path1 = r'E:\桌面文件存放\Code\Python\大创项目\VMD\normal_result_right_fixed_k_output.xlsx'
# data1 = pd.read_excel(data_path1)
# rms1 = data1['RMS_Right']
# data_path2 = r'E:\桌面文件存放\Code\Python\大创项目\VMD\bomo_result_right_fixed_k_output.xlsx'
# data2 = pd.read_excel(data_path2)
...
check =   1.4611507137600297 # 左轨波磨阈值，由`IMF_time_rms_std_multiple_left_vmd.py`计算正常路段的RMS与STD的平均值之和
# check = 0.8936450031251459  # 右轨波磨阈值 由`IMF_time_rms_std_multiple_right_vmd.py`计算正常路段的RMS与STD的平均值之和
